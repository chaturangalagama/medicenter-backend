...
<%
	String[] supportedFormats = {"pdf","xlsx"};
%>
<%-----------------------------------------------------------------------------
				...
				<TABLE>
					<TR>
						...
						<TD STYLE="padding-left:5px">	
							<INPUT TYPE="radio" ID="exportPageCurrent" NAME="exportPages" CHECKED/><%=BirtResources.getHtmlMessage( "birt.viewer.dialog.page.current" )%>
						</TD>	
						<TD STYLE="padding-left:5px;">
