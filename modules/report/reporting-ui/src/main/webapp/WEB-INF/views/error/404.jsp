...
<br>
<br>
  <label style="font-size: 50px; text-align: center;font-weight: 700;">404</label>
    <br>
    <br>
  <label style="font-size: 20px; text-align: center;font-weight: 700;">Requested Resource Not Found</label>
    <br>
    <br>
    <br>
