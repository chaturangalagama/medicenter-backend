...
@Service
public class MongoPatientVisitRegistryDatabaseService implements PatientVisitRegistryDatabaseService {

    private PatientVisitRegistryRepository registryRepository;
    private MongoTemplate mongoTemplate;

    public MongoPatientVisitRegistryDatabaseService(PatientVisitRegistryRepository registryRepository, MongoTemplate mongoTemplate) {
