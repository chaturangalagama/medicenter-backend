package com.ilt.cms.db.service.appointment;
...
@Service
public class MongoCalendarDatabaseService implements CalendarDatabaseService {
    ...
    public MongoCalendarDatabaseService(AppointmentRepository appointmentRepository, ClinicCalendarRepository clinicCalendarRepository, DoctorCalendarRepository doctorCalendarRepository) {
