package com.ilt.cms.pm.integration.downstream.clinic.system;
...
import com.ilt.cms.downstream.clinic.system.SystemConfigurationDownstream;
...
@Service
public class DefaultSystemConfigurationDownstream implements SystemConfigurationDownstream {
    private static final Logger logger = LoggerFactory.getLogger(DefaultSystemConfigurationDownstream.class);
    ...
    public DefaultSystemConfigurationDownstream(DoctorService doctorService, ClinicService clinicService,
