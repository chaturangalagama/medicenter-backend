package com.ilt.cms.pm.integration.downstream.clinic.inventory;

import com.ilt.cms.api.entity.item.ItemEntity;
import com.ilt.cms.core.entity.item.Item;
import com.ilt.cms.core.entity.system.SystemStore;
import com.ilt.cms.downstream.clinic.inventory.ItemDownstream;
...
@Service
public class DefaultItemDownstream implements ItemDownstream {

    private static final Logger logger = LoggerFactory.getLogger(DefaultItemDownstream.class);
    private ItemService itemService;

    public DefaultItemDownstream(ItemService itemService) {
