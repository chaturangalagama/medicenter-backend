...
import com.ilt.cms.downstream.clinic.FileManagementDownstream;
...
@Service
public class DefaultFileManagementDownstream implements FileManagementDownstream {

    private static final Logger logger = LoggerFactory.getLogger(DefaultFileManagementDownstream.class);
    private FileManagementService fileManagementService;

    public DefaultFileManagementDownstream(FileManagementService fileManagementService) {
