...
@Service
public class DefaultPatientDownstream implements PatientDownstream {
    private static final Logger logger = LoggerFactory.getLogger(DefaultPatientDownstream.class);
    private PatientService patientService;

    public DefaultPatientDownstream(PatientService patientService) {
