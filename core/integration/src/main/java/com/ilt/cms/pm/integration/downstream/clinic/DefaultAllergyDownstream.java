...
import com.ilt.cms.downstream.clinic.AllergyDownstream;
...
@Service
public class DefaultAllergyDownstream implements AllergyDownstream {
    ...
    public DefaultAllergyDownstream(AllergyGroupService allergyGroupService){
