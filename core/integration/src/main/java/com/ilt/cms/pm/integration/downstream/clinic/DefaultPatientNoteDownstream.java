...
@Service
public class DefaultPatientNoteDownstream implements PatientNoteDownstream {
    private static final Logger logger = LoggerFactory.getLogger(DefaultPatientNoteDownstream.class);
    private PatientNoteService patientNoteService;

    public DefaultPatientNoteDownstream(PatientNoteService patientNoteService){
