...
public class PatientVisitRegistryMapper {
    ...
    public static VisitRegistryEntity mapToEntity(PatientVisitRegistry patientVisitRegistry) {
        ...
        if (patientVisitRegistry.getMedicalReference() != null) {
            registryEntity.setMedicalReferenceEntity(MedicalReferenceMapper.mapToEntity(patientVisitRegistry.getMedicalReference()));
        }
    ...
    public static PatientVisitRegistry mapToCore(VisitRegistryEntity registryEntity) {
        ...
        if (registryEntity.getMedicalReferenceEntity() != null) {
            visitRegistry.setMedicalReference(MedicalReferenceMapper.mapToCore(registryEntity.getMedicalReferenceEntity()));
        }
