...
import com.ilt.cms.downstream.clinic.LabelDownstream;
...
@Service
public class DefaultLabelDownstream implements LabelDownstream {
    private static final Logger logger = LoggerFactory.getLogger(DefaultLabelDownstream.class);
    private LabelService labelService;

    public DefaultLabelDownstream(LabelService labelService){
