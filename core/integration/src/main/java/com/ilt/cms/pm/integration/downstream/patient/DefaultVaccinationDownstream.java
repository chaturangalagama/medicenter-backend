package com.ilt.cms.pm.integration.downstream.patient;
...
@Service
public class DefaultVaccinationDownstream implements VaccinationDownstream {
    private static final Logger logger = LoggerFactory.getLogger(DefaultVaccinationDownstream.class);

    private VaccinationService vaccinationService;

    public DefaultVaccinationDownstream(VaccinationService vaccinationService){
