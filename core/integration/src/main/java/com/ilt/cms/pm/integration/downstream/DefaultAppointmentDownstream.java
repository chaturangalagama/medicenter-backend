...
import com.ilt.cms.pm.integration.mapper.AppointmentMapper;
...
@Service
public class DefaultAppointmentDownstream implements AppointmentDownstream {
    private static final Logger logger = LoggerFactory.getLogger(DefaultAppointmentDownstream.class);

    private AppointmentService appointmentService;

    public DefaultAppointmentDownstream(AppointmentService appointmentService) {
