...
public class AppointmentRestController {
    ...
    private AppointmentDownstream appointmentDownstream;

    public AppointmentRestController(AppointmentDownstream appointmentDownstream) {
        this.appointmentDownstream = appointmentDownstream;
    }
...
//        logger.info("Create appointment  [" + name + "]");
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.createAppointment(appointmentEntity);
...
//        logger.info("Update appointment  [" + name + "]");
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.modifyAppointment(appointmentId, appointmentEntity);
        return serviceResponse;
    }
...
//        logger.info("Delete appointment  [" + name + "]");
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.deleteAppointment(appointmentId);
        return serviceResponse;
    }
    ...
    public HttpEntity<ApiResponse> searchAppointment(@RequestBody Map<String, List<String>> idsMap,
        ...
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.searchAppointment(clinicIds,
    ...
    public HttpEntity<ApiResponse> listConflictAppointment(@PathVariable("clinicId") String clinicId) {
        ...
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.listConflictAppointment(clinicId);
        return serviceResponse;
    }
    ...
    public HttpEntity<ApiResponse> findClinicCalendar(@PathVariable("clinicId") String clinicId) {
        ...
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.findClinicCalendar(clinicId);
        return serviceResponse;
    }
    ...
    public HttpEntity<ApiResponse> findDoctorCalendar(@PathVariable("clinicId") String clinicId,
        ...
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.findDoctorCalendar(clinicId, doctorId);
        return serviceResponse;
    ...
    public HttpEntity<ApiResponse> updateClinicWorkingHour(@PathVariable("clinicId") String clinicId,
        ...
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.updateClinicWorkingHour(clinicId, workingHourTimeSlots);
        return serviceResponse;
    }
    ...
    public HttpEntity<ApiResponse> updateClinicHoliday(@PathVariable("clinicId") String clinicId,
        ...
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.updateClinicHoliday(clinicId, holidayTimeSlots);
        return serviceResponse;
    ...
    public HttpEntity<ApiResponse> updateDoctorLeave(@PathVariable("clinicId") String clinicId,
        ...
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.updateDoctorLeave(clinicId, doctorId, leaveTimeSlots);
        return serviceResponse;
    ...
    public HttpEntity<ApiResponse> updateDoctorWorkingDay(@PathVariable("clinicId") String clinicId,
        ...
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.updateDoctorWorkingDay(clinicId, doctorId, workingDayTimeSlots);
        return serviceResponse;
    }
    ...
    public HttpEntity<ApiResponse> addDoctorBlockTime(@PathVariable("clinicId") String clinicId,
        ...
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.addDoctorBlockTime(clinicId, doctorId, date, start, end);
        return serviceResponse;
    }
    ...
    public HttpEntity<ApiResponse> removeDoctorBlockTime(@PathVariable("clinicId") String clinicId,
        ...
        logger.info("Add doctor block time []");
        ResponseEntity<ApiResponse> serviceResponse = appointmentDownstream.removeDoctorBlockTime(clinicId, doctorId, dateTime);
        return serviceResponse;
    }
